...
def main():
    ...
    st.markdown("<h1 class='main-header'>Kisan Mind: Your Free Crop Diagnosis and Treatment App</h1>", unsafe_allow_html=True)
    ...
    <div class='footer'>
        <p>© 2025 Kisan Mind India | Made with ❤️ by <a href="https://www.linkedin.com/in/samyukthajeevanantham/">Samyuktha 🍁</a> | 
        <a href="https://www.linkedin.com/in/samyukthajeevananatham/">LinkedIn</a> | 
        <a href="https://github.com/Samyuktha2675">GitHub</a></p>
    </div>
    """, unsafe_allow_html=True)
